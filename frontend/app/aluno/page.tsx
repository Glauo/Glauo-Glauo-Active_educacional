              ...
              <table className="data-table">
                ...
                <tbody>
                  {minhasFaturas.map((f, i) => {
                    ...
                    const boletoPdf = f.boleto_pdf_b64 && f.id
                      ? `/api/financeiro/boleto-pdf?id=${encodeURIComponent(String(f.id))}`
                    ...
                    return (
                      <tr key={String(f.id || i)}>
                        ...
                        <td>
                          {boletoPdf ? (
                            <a className="btn btn-secondary btn-sm" href={boletoPdf} target="_blank" rel="noreferrer">Baixar boleto</a>
