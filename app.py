...
if not st.session_state.get("logged_in", False):
    ...
    <style>
        ...
        :root { --sidebar-width: 360px; --sidebar-menu-btn-width: 100%; }
        ...
        section[data-testid="stSidebar"] a[data-testid^="stPageLink"] { width: var(--sidebar-menu-btn-width) !important; min-width: var(--sidebar-menu-btn-width) !important; max-width: var(--sidebar-menu-btn-width) !important; margin-right: 0 !important; margin-left: 0 !important; }
        section[data-testid="stSidebar"] .stButton > button,
        section[data-testid="stSidebar"] div[data-testid="stButton"] > button,
        section[data-testid="stSidebar"] a[data-testid^="stPageLink"],
        section[data-testid="stSidebar"] button[data-testid^="stBaseButton"],
        section[data-testid="stSidebar"] button[kind="secondary"],
        section[data-testid="stSidebar"] button[kind="primary"] { background: #f6f9ff; border: 1px solid #dbe7f6; color: #475569; text-align: left; font-weight: 700; padding: 0 1rem; width: var(--sidebar-menu-btn-width) !important; min-width: var(--sidebar-menu-btn-width) !important; max-width: var(--sidebar-menu-btn-width) !important; border-radius: 14px; transition: all 0.2s ease; margin-bottom: 8px; box-shadow: 0 6px 16px rgba(15, 23, 42, 0.06); height: 56px !important; min-height: 56px !important; max-height: 56px !important; display: flex; align-items: center; justify-content: flex-start; box-sizing: border-box; white-space: nowrap; overflow: visible; text-overflow: clip; }
        section[data-testid="stSidebar"] .stButton > button p,
        section[data-testid="stSidebar"] div[data-testid="stButton"] > button p,
        section[data-testid="stSidebar"] a[data-testid^="stPageLink"] p,
        section[data-testid="stSidebar"] a[data-testid^="stPageLink"] span { margin: 0 !important; line-height: 1 !important; white-space: nowrap !important; overflow: visible !important; text-overflow: clip !important; }
